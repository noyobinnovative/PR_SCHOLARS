...
const courseSubjects = {
    nda: ["Mathematics", "GAT"],
    cds: ["Mathematics", "GK"],
    afcat: ["Numerical & Reasoning Ability", "General Awareness"],
...
function generateSlots() {
    ...
    selectedSubjects.forEach(subjectCheckbox => {
        ...
        if (slots.length > 0) {
            ...
            slotContainer.innerHTML += `<h5>${subject}</h5>`;
...
const slotContainer =
    ...
    .addEventListener("change", generateSlots);

    subjectContainer.addEventListener("change", function (e) {
